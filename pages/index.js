    ...
    <>
      ...
      <div className="w-full">
        <Head>
          ...
          <meta
            name="description"
            content="Carmazon ECommerce Next provides a way to To Buy Special Car Parts Online."
          />
          <meta property="og:title" content="Carmazone " key="title" />
        </Head>
        <div
        ...
        >
          <div className="pt-4 pl-2 sm:pt-12 sm:pl-12 flex flex-col">
            <Tag year="2022" category="Accessories" />
            <Center
              price="200"
              title={inventory[2].name}
              link={`/product/${slugify(inventory[2].name)}`}
            />
            <Footer designer="Amir Mansour" />
          </div>
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        ...
        <p className="text-gray-600 text-sm">
          Find the perfect piece or accessory to finish off your Vehicle in Your
          Garage.
        </p>
      </div>
